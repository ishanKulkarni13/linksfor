...
export default function TermsPage() {
  return (
    <main style={{ maxWidth: 800, margin: "0 auto", padding: "32px 16px" }}>
      ...
      <h2>2. Eligibility</h2>
      <p>
        You must be at least 13 years old to use this Service. By using the Service, you represent and warrant that you have the full right, power, and authority to enter into and comply with these Terms.
      </p>
      ...
      <ul>
        ...
        <li>Upload viruses or malicious code or do anything that could disable, overburden, or impair the proper working of the Service.</li>
        <li>Attempt to gain unauthorized access to the Service, user accounts, or computer systems.</li>
        <li>Scrape, crawl, or use any automated means to access the Service.</li>
        <li>Post spam, chain letters, or pyramid schemes.</li>
        <li>Violate any applicable laws or regulations.</li>
      </ul>

      <h2>6. Service Availability</h2>
      <p>
        We strive to keep the Service up and running; however, all online services suffer occasional disruptions and outages. We are not liable for any disruption or loss you may suffer as a result. We reserve the right to modify, suspend, or discontinue the Service at any time, with or without notice.
      </p>
      ...
      <h2>9. Termination</h2>
      <p>
        We may terminate or suspend your account and bar access to the Service immediately, without prior notice or liability, under our sole discretion, for any reason whatsoever and without limitation, including but not limited to a breach of the Terms. If you wish to terminate your account, you may simply discontinue using the Service or contact us for deletion.
      </p>
      ...
      <h2>18. Contact Us</h2>
      <p>
        If you have any questions about these Terms, please contact us at <a href="mailto:support@linksfor.app">support@linksfor.app</a>.
      </p>

      <h2>19. Additional Provisions</h2>
      <p>
        <strong>19.1. Service Updates:</strong> We may update, change, or discontinue any aspect of the Service at any time, including adding or removing features. We are not liable for any modification, suspension, or discontinuance of the Service.
      </p>
      <p>
        <strong>19.2. Feedback:</strong> If you provide us with any feedback or suggestions regarding the Service, you hereby assign to us all rights in such feedback and agree that we shall have the right to use and fully exploit such feedback in any manner we deem appropriate. We will treat any feedback you provide as non-confidential and non-proprietary.
      </p>
      <p>
        <strong>19.3. Data Retention:</strong> We may retain your data for as long as your account is active or as needed to provide you services, comply with our legal obligations, resolve disputes, and enforce our agreements.
      </p>
      <p>
        <strong>19.4. International Users:</strong> The Service is controlled and operated from our facilities. If you access the Service from outside our country, you are responsible for compliance with local laws.
      </p>
      <p>
        <strong>19.5. Notices:</strong> We may provide notices to you via email, written or hard copy notice, or through posting on our website, as determined by us in our sole discretion.
      </p>
      <p>
        <strong>19.6. Assignment:</strong> You may not assign or transfer these Terms, by operation of law or otherwise, without our prior written consent. Any attempt by you to assign or transfer these Terms, without such consent, will be null and of no effect. We may assign or transfer these Terms at our sole discretion without restriction.
      </p>
      <p>
        <strong>19.7. Survival:</strong> All provisions of the Terms which by their nature should survive termination shall survive termination, including, without limitation, ownership provisions, warranty disclaimers, indemnity, and limitations of liability.
      </p>
      <p>
        <strong>19.8. Headings:</strong> Headings are for reference purposes only and do not limit the scope or extent of such section.
      </p>
      <p>
        <strong>19.9. Language:</strong> These Terms may be translated into other languages for your convenience. In the event of a conflict between the English version and a translated version, the English version will control.
      </p>
      <p>
        <strong>19.10. Force Majeure:</strong> We shall not be liable for any failure to perform our obligations hereunder where such failure results from any cause beyond our reasonable control, including, without limitation, mechanical, electronic or communications failure or degradation.
      </p>
      <p>
        <strong>19.11. Relationship:</strong> No agency, partnership, joint venture, or employment is created as a result of these Terms and you do not have any authority of any kind to bind us in any respect whatsoever.
      </p>
      <p>
        <strong>19.12. Publicity:</strong> You agree that we may identify you as a user of the Service and use your name and logo in our promotional materials, subject to your right to withdraw such consent at any time by written notice.
      </p>
      <p>
        <strong>19.13. No Third-Party Beneficiaries:</strong> These Terms are between you and us. There are no third-party beneficiaries to these Terms.
      </p>
      <p>
