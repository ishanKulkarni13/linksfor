  ...
  return (
    <Drawer.Root>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          className={`bg-gray-100 flex flex-col rounded-t-[10px] mt-24 h-fit fixed bottom-0 left-0 right-0 outline-none ${styles.drawerContent}`}
        >
          <div className={styles.drawerChildren}>
            {" "}
            <TreePreview className={styles.treePreview} treeUID={treeUID} />
          </div>
