...
export default function Pofile({ treeName, treePicture, treeBio, isVerified }) {
    ...
    <div className={styles.profileContainer}>
      <Avatar className={styles.profilePictureContainer}>
        <AvatarImage
          ...
          alt="Prfile Pic"
        />
        <AvatarFallback className={styles.avatarFallback} delayMs={5 * 100}>
          {getInitials(treeName)}
        </AvatarFallback>
      </Avatar>
      ...
      <div className={styles.profileTextContainer}>
        <div className={`${styles.nameContainer}`}>
          ...
          {!!isVerified && (
            ...
            >
              <g>
                {/* <!-- Outer blue shape with black border --> */}
                <path
                  ...
                  className={styles.verifiedIconFill}
                  // stroke="black"
                  stroke-width="0.7"
                ></path>
                ...
                {/* <!-- Black tick --> */}
                <path
                className={styles.verifiedIconTick}
